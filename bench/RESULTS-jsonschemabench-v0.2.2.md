...
| TBM p75 | 34 | 21 | 29 |
| TBM p90 | 63 | 31 | 57 |
| TBM p95 | 7,303 | 57 | 326 |
| TBM p99 | 7,532 | 179 | 2,658 |
| TBM p99.9 | 7,924 | 1,055 | 7,472 |
| TBM max | 14,826 | 2,013 | 12,049 |
| TTFM avg | 111,436 | 595 | 689,160 |
| TTFM p25 | 4,815 | 227 | 770 |
| TTFM p50 | 7,011 | 313 | 2,393 |
| TTFM p75 | 11,756 | 436 | 209,317 |
| TTFM p90 | 73,265 | 821 | 1,170,668 |
| TTFM p95 | 578,444 | 1,704 | 2,964,222 |
| TTFM p99 | 3,350,921 | 7,721 | 13,010,521 |
| tokens | 67,031 | 62,311 | 70,275 |
| schemas | 315 | 315 | 315 |
| passing | 271 | 251 | 283 |
| compile error | 38 | 62 | 0 |
| timeout | 0 | 0 | 0 |
...
Ignored-but-accepted constraints (counted per schema; the XGrammar-default convention — these surface as invalidation errors when an invalid instance hinges on them): oneOf-exclusivity (18), required-not-enforced (required-set beyond cap) (12), length (length window (0,1024) beyond cap) (5), scanner-budget: constrained string degraded (5), scanner-budget: length window degraded (4), uniqueItems (3), length (length window (0,500) beyond cap) (3), length (length window (0,256) beyond cap) (3), length (length window (0,4096) beyond cap) (3), format:expose (2), length (length window (0,65535) beyond cap) (2), maxLength-with-pattern (2).

Compile-error reasons (v1 subset boundaries, llguidance-style upfront): LALRConflictError (15), Unsupported: allOf (merge failed) (5), Unsupported: unsupported keys ['not'] (5), Unsupported: patternProperties overlaps declared key (merge) (3), Unsupported: anyOf with sibling keys ['additionalProperties' (2), Unsupported: patternProperties with propertyNames/forbid (2), Unsupported: patternProperties complement '^[a-zA-Z0-9]([a-z (1), Unsupported: oneOf with sibling keys ['required'] (1), Unsupported: rule budget exceeded (size cap) (1), Unsupported: anyOf with sibling keys ['minProperties'] (1).
