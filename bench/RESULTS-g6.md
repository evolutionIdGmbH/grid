...
Host: local M-series dev (unpinned), kernel v4 | grammar `grammars/sql_subset.grid` + L3 schema lexicons + role projections | tokenizer `Qwen/Qwen2.5-0.5B-Instruct` (151,665 tokens)
