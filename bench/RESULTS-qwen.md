...
> Measured at GRID v0.0.7 (kernel v7, pre-0.2.x coverage epoch). Numbers are version-pinned history; the current JSON front end is benchmarked in RESULTS-jsonschemabench-v0.4.0rc1.md.
